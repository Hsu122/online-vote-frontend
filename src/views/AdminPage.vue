<template>
  <div class="p-4">
    <h1 class="text-2xl font-bold mb-4">管理投票項目</h1>
    <div class="mb-4">
      <input v-model="newItemName" placeholder="輸入投票項目名稱" class="border p-2 mr-2" />&nbsp;
      <button @click="addItem" class="bg-blue-500 text-white px-4 py-2">新增項目</button>
    </div>
    <br />
    <ul>
      <li
